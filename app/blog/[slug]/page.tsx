...
export default async function DocPage(props: Props) {
  ...
  const mdx = await serializeMdx(post.body ?? "");
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[22rem_2.5rem_auto] xl:grid-rows-[1fr_auto]">
        ...
        <div className="max-xl:mx-auto max-xl:w-full max-xl:max-w-(--breakpoint-md)">
          ...
          <GridContainer className="mb-6 px-4 lg:px-2 xl:mb-16">
            <h1 className="inline-block max-w-2xl text-[2.5rem]/10 tracking-tight text-pretty text-gray-950 max-lg:font-medium lg:text-6xl dark:text-gray-200">
              {post.title}
            </h1>
          </GridContainer>
        </div>
        ...
        <div className="max-xl:mx-auto max-xl:w-full max-xl:max-w-(--breakpoint-md)">
          <div className="flex flex-col gap-4">
            ...
            >
              <Author author={{ avatar: "/author.jpg", github: "AWKohler", name: "Aronne Kohler" }} />
            </GridContainer>
          </div>
        </div>
        ...
        <div className="max-xl:mx-auto max-xl:mt-16 max-xl:w-full max-xl:max-w-(--breakpoint-md)">
          <GridContainer className="px-4 py-2 lg:px-2">
            <article className="mdx-content max-w-3xl font-tomato-sans">
...
function Author({ author }: { author: { avatar: string; github: string; name: string } }) {
  return (
